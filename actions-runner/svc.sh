...
SVC_NAME="actions.runner.hoangdangnhatkha-226MessageWebServer.ics226.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (hoangdangnhatkha-226MessageWebServer.ics226)"
